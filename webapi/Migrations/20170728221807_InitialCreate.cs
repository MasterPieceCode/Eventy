        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPrincipal = table.Column<bool>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefData_EventId",
                table: "RefData",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_RefData_UserId1",
                table: "RefData",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_RefData_Name",
                table: "RefData",
                column: "Name",
                unique: true);

            migrationBuilder.AddForeignKey(
                name: "FK_RefData_Cards_EventId",
                table: "RefData",
                column: "EventId",
